  ...
  await database.collection("payments").updateOne(
    ...
    },
    {
      $setOnInsert: {
        ...
        amount:
          Number(session.amount_total || 500) / 100,
    ...
    try {
      ...
      if (
        ...
        return res.status(409).json({
          message:
            "This marketplace account already has premium access.",
        });
      }
